...
```html [Form.tsx]
  return (
    <div>
      <input type="text" name="name" value={userFrom.name}  />
      <input type="text" name="email" value={userFrom.email}  />
      <input type="text" name="age" value={userFrom.age}  />
    </div>
  );
```
...
import { useForm, Validators } from '@nattyjs/tidy'; // Assuming '@nattyjs/tidy' is installed
...
const Form = () => {
  ...
  const [userForm, setUserForm] = useState(useForm(user, {
    validators: {
      name: Validators.required(),
      email: [Validators.required(), Validators.email()],
      age: [Validators.required(), Validators.numeric()],
  ...
  return (
    <div>
      ...
      <input type="text" name="age" value={userForm.age} />
      <span>{userForm.age.errorMessage}</span>
